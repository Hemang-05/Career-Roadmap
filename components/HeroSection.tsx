    ...
    async function checkUserRoadmap() {
      ...
      try {
        ...
        if (careerError) {
          ...
          const roadmapExists = !!(careerData && careerData.roadmap && careerData.roadmap.trim().length > 0);
    ...
    >
      ...
      <div className="md:w-1/2 mb-10 md:mb-0 md:pr-8 text-center md:text-left z-10">
        ...
        <p className="text-xl text-gray-600 mb-20">
          We guide you from the first step to the finish line, ensuring no opportunity slips by.
        </p>
        {/* Button Section */}
