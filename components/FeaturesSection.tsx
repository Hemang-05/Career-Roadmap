...
//       imageUrl:
//         "https://res.cloudinary.com/ditn9req1/image/upload/v1743938065/1_gfdydi.webp", // Replace with your actual image URLs
//     },
//     {
//       id: "events-updates",
...
//   const [displayedFeature, setDisplayedFeature] = useState<string>(
//     features[0].id
//   );
...
//       ? features.find((f) => f.id === previousFeature) || null
//       : null;
//   };
...
export default function FeaturesSection() {
  ...
  useEffect(() => {
    if (isTransitioning && nextFeature) {
      // Start fade-out, then after fade-out completes, update displayed feature and fade-in
      const timer = setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        {/* Right side: Feature image - Show above accordion on mobile */}
        <div className="w-full lg:w-1/2 order-1 lg:order-2 mb-8 lg:mb-0">
          <div className="relative pt-[76.78%] mt-8 overflow-hidden bg-white/20 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30">
            <div
              className={`absolute inset-0 transition-opacity duration-500 ${
