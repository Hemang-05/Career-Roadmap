...
//                 <h2 className="text-lg md:text-lg mb-3 md:mb-4 text-black font-thin">
...
//                 <span className="font-extrabold text-black text-2xl md:text-3xl">
//                   {desiredCareer}
//                 </span>
//               </div>
//             </>
...
//             <div className="bg-white p-6 md:p-8 rounded-[4rem] border border-slate-200/60  backdrop-blur-sm text-center max-w-md mx-auto">
//               {/* Error Message */}
//               <div className="mb-6">
//                 <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-red-400 to-red-500 rounded-full flex items-center justify-center">
//                   <svg
